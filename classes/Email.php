    ...
    public function EnviarConfirmacion()
    {
        ...
        $contenido = "<html>
                ...
                <body>
                    ...
                    <p>Has creado tu cuenta en UpTask. Para confirmar tu cuenta, por favor presiona el siguiente enlace:</p>
    ...
    public function enviarInstrucciones()
    {
        ...
        $contenido = "<html>
                ...
                <body>
                    ...
                    <p><a href='" . $_ENV['PROJECT_URL'] . "/restablecer?token=" . $this->token . "'>Restablecer contraseña</a></p>
